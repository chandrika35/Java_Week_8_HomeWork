 ...
 * Create package name ‘encapsulation26’ and create all  below classes in this package
 */


public class Encapsulate {
  //private variables declared these can ony be accessed by public methods of class
    private String name;
    private int rollNo;
    private int age;
